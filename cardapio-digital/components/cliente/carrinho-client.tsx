        ...
        <>
          ...
          <div className="px-4 py-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="font-semibold text-gray-800 text-sm">Adicionar ao pedido</h2>
            </div>
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1">
              {suggestions.map((product) => (
                <button
                  ...
                  className="flex-shrink-0 w-36 bg-gray-50 rounded-xl overflow-hidden border border-gray-100 hover:border-orange-300 transition-colors text-left"
                >
                  {product.image_url ? (
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-xs font-bold text-orange-500 mt-1">{formatCurrency(product.base_price)}</p>
                    <div className="mt-2 text-center bg-orange-500 text-white text-xs font-semibold rounded-lg py-1">
                      + Adicionar
                    </div>
                  </div>
                </button>
